...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Rails lib for creating an ActiveRecord model to handle Sidekiq background jobs'
  spec.description   = 'Rails lib for creating an ActiveRecord model to handle Sidekiq background jobs'
